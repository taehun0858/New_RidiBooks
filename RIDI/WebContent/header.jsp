		...
		<nav>
			<div class="logo">
				<ul class="logowrapper">
					<li><svg viewBox="0 0 316 49" class="fig-1bk8rmg">
							<title>리디북스</title><path
				...
				<div class="search">
					<div class="searchbox">
						<label for="search"> <svg
								...
								width="1em" height="1em" aria-label="인스턴트 검색"
								class="fig-yqjege erwx1ai0">
								<path
									...
									fill="currentColor"></path></svg> <input type="text" class="search" id="backend-search"
			...
			<li class="home"><a href="/ridibooks/">
					<div class="headerlogo">
						<svg viewBox="0 0 24 24" class="fig-20c2qt">
							<path
								d="M11.293 2.293l-9 9a1 1 0 00-.294.707v10.086a.5.5 0 00.5.5h5.997a.5.5 0 00.5-.5v-6.498c0-.554.448-1.002 1.002-1.002h4.004c.553 0 1.002.448 1.002 1.002v6.498a.5.5 0 00.5.5H21.5a.5.5 0 00.5-.5V12a.998.998 0 00-.293-.707l-9-9a1 1 0 00-1.415 0"></path></svg>
						<span>홈</span>
					</div>
			</a></li>
...
<script src="js/jquery-3.6.0.min.js"></script>
 <script>
	// ID를 backend-search로 가지는 곳에서 키를 누를 경우
	$("#backend-search").keydown(
			function(key) {
				let searchWord = $("#backend-search").val();
...
<script>
	...
	const element = document.getElementById("logincheck");
	$.ajax({        		
		url:"/ridibooks/logincheck",
		type:"GET",
		success: function(){		
				    element.innerHTML = 
					"<li><a href=\"#\" class=\"signupbtn\" >캐시충전하기</a></li>"
					+"<li><a href=\"#\" class=\"loginbtn\" >내 서재</a></li>"
					},
		error:function(){
